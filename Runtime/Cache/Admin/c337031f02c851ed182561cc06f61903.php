...
<body>
                ...
                <?php switch($field["type"]): case "text": ?><input type="text" name="<?php echo ($field["name"]); ?>" value="<?php echo ($field["value"]); ?>" class="text input-large"/><?php break;?>
                    ...
                    <?php case "image": ?><div class="controls">
                            ...
                            <div class="upload-img-box">
                                <?php if(!empty($field["value"])): ?><div class="upload-pre-item"><img src="/onethink<?php echo (get_cover($field["value"],'path')); ?>"/></div><?php endif; ?>
                            </div>
                        </div>
    ...
    <?php if($importDatetimePicker): ?><link href="/onethink/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
