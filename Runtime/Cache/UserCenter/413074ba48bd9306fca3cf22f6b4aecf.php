...
<div class="row">
    ...
    <?php $homeProfile = D('Home/Member')->where(array('uid'=>$uid))->find(); ?>
    ...
    <div class="row">
        <div class="col-xs-3">
            <p class="pull-right">输入新的签名：</p>
        </div>
        <div class="col-xs-6">
            <form id="changePasswordForm" action="<?php echo U('UserCenter/Index/doChangeSignature');?>" method="post" class="ajax-form">
                <p>
                    <textarea name="signature" class="form-control" style="width: 100%; height: 6em;"><?php echo (htmlspecialchars($homeProfile["signature"])); ?></textarea>
                </p>
