...
<div class="row">
    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            ...
            <form action="<?php echo U('UserCenter/Index/doUploadAvatar');?>" id="avatar_form" method="post"
            ...
            <div id="uploaded_image_div" style="display: none;">
                ...
                <p>
                    <a class="btn btn-primary" id="save_avatar_button" data-url="<?php echo U('UserCenter/Index/doCropAvatar');?>">选区裁剪后保存头像</a>
                </p>
            </div>
        </div>
    </div>
...
(function(){
    ...
    <link rel="stylesheet" type="text/css" href="/onethink/Public/static/jcrop/jquery.Jcrop.css"/>
    <script src="/onethink/Public/static/jcrop/jquery.Jcrop.js"></script>
    <script src="/onethink/Public/static/browser/jquery.browser.js"></script>
    <script>
        var temp;
