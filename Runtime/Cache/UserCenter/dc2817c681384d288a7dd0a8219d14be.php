...
<div class="row">
    ...
    <?php $user = query_user(array('email')); ?>
    ...
    <div class="row">
        <div class="col-xs-3">
            <p class="pull-right">输入新邮箱：</p>
        </div>
        <div class="col-xs-6">
            <form action="<?php echo U('UserCenter/Index/doChangeEmail');?>" method="post" class="ajax-form">
                <p>
                    <input type="text" name="email" class="form-control" placeholder="输入邮箱" value="<?php echo ($user["email"]); ?>"/>
                </p>
                <p>
